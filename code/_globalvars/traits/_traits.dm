...
GLOBAL_LIST_INIT(traits_by_type, list(
	...
	/atom/movable = list(
		...
		"TRAIT_FACING_TO_MOUSE" = TRAIT_FACING_TO_MOUSE,
	...
	/mob = list(
		...
		"TRAIT_COMBAT_EXOFRAME_EMP_SHIELD" = TRAIT_COMBAT_EXOFRAME_EMP_SHIELD,
		...
		"TRAIT_FALLING_INTO_BINGLE_HOLE" = TRAIT_FALLING_INTO_BINGLE_HOLE,
		...
		"TRAIT_FRACTURE_FALL" = TRAIT_FRACTURE_FALL,
		...
		"TRAIT_MARTIAL_ARTS_SUPPRESSED" = TRAIT_MARTIAL_ARTS_SUPPRESSED,
		"TRAIT_MASTER_SURGEON" = TRAIT_MASTER_SURGEON,
		"TRAIT_MESON_VISION" = TRAIT_MESON_VISION,
		"TRAIT_MINDSHIELD_HUD" = TRAIT_MINDSHIELD_HUD,
		...
		"TRAIT_NO_RADIATION_EFFECTS" = TRAIT_NO_RADIATION_EFFECTS,
	...
	/datum/controller/subsystem/processing/station = list(
		...
		"STATION_TRAIT_CLASSIC_ASSISTANTS" = STATION_TRAIT_CLASSIC_ASSISTANTS,
		"STATION_TRAIT_CRAMPED_INTERNALS" = STATION_TRAIT_CRAMPED_INTERNALS,
		...
		"STATION_TRAIT_GREEN_ENERGY" = STATION_TRAIT_GREEN_ENERGY,
		"STATION_TRAIT_HANGOVER" = STATION_TRAIT_HANGOVER,
		"STATION_TRAIT_LATE_ARRIVALS" = STATION_TRAIT_LATE_ARRIVALS,
		"STATION_TRAIT_LOOTED_ARMORY" = STATION_TRAIT_LOOTED_ARMORY,
		"STATION_TRAIT_MEDBOT_MANIA" = STATION_TRAIT_MEDBOT_MANIA,
		"STATION_TRAIT_MIMANIUM_SHIPMENTS" = STATION_TRAIT_MIMANIUM_SHIPMENTS,
		"STATION_TRAIT_OUTDATED_HARDSUITS" = STATION_TRAIT_OUTDATED_HARDSUITS,
		"STATION_TRAIT_PDA_GLITCHED" = STATION_TRAIT_PDA_GLITCHED,
		"STATION_TRAIT_POST_WAR_TRASH" = STATION_TRAIT_POST_WAR_TRASH,
		...
		"STATION_TRAIT_UPGRADED_ARMORY" = STATION_TRAIT_UPGRADED_ARMORY,
	),
	// MARK: Liver Traits
